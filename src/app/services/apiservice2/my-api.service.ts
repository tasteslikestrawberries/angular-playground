...
export class MyApiService {
  ...
  fetchUser() {
    //each call to this method sends a new get request
    this.httpClient.get(this.url).subscribe({
      // angular uses observable pattern instead of promises.
      ...
      // in case of successful completition, it calls observer.next()
      next: (data: any) => {
